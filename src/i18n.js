    ...
    resources: {
      ua: {
        translation: {
          ...
          translationText8:
            ...
            // Form of payment
          pay: "Оплатити",
          enter: "Введіть суму оплати",
          example: "Наприклад",
          cancel: "Скасувати",
          amount: "Введіть суму більше 0",
          loading: "Завантаження...",
          failed: "Помилка при створенні сесії оплати",
      ...
      ja: {
        translation: {
          ...
          example: "例",
          cancel: "キャンセル",
          amount: "0 より大きい金額を入力してください",
          loading: "読み込み中...",
          failed: "支払いセッションの作成に失敗しました",
          wrong: "問題が発生しました",
        },
      },
      ru: {
        translation: {
          ...
          userName1: "Хидео Накамура",
          userName2: "Курода",
          userName3: "Дайсаку Ёшимура",
          userName4: "Иноуэ",
          userPosition1:
            "Общий фонд Ассоциации народной музыки MIN-ON Плановый отдел штаба планирования",
          userPosition2: "Профессор, Педагогический университет Киото",
          userPosition3: "Генеральный директор ООО 'NextAge Inc.'",
          userPosition4: "Репортёр TBS",
          questions1: "Как вы меня нашли?",
          questions2: "Почему вы обратились ко мне?",
          questions3:
            "Было ли это полезно? Удалось ли решить проблему? Вы довольны результатами?",
          questions3NextAge:
            "Было ли это полезно для NextAge? Удалось ли вам решить проблему? Довольны ли вы результатами?",
          questions4: "Было ли это полезно для отдела международных новостей?",
          replies1:
            "По рекомендации директора НПО Японско-Украинской Культурной Ассоциации.",
          replies2:
            "Это произошло потому, что нам был необходим украинский переводчик для японского тура Национального заслуженного академического ансамбля танца Украины имени Павла Вирского, спонсируемого нашей организацией.",
          replies3:
            "Тур продолжался два месяца, и всё это время переводчица Ирина тщательно заботилась о том, чтобы участники из Украины чувствовали себя спокойно в Японии, а также осуществляла перевод на официальных мероприятиях. Мы очень довольны успешными выступлениями танцевального коллектива. Ещё раз благодарим за ваши усилия и заботу.",
          replies4:
            "Когда мы искали переводчика с украинского языка вместе с компанией NextAge Inc., Ирина предложила нам свою помощь. После этого она взяла на себя инициативу и нашла около 10 переводчиков через социальные сети.",
          replies5:
            "Мы искали переводчика, владеющего как японским, так и украинским языками, чтобы помочь украинским детям, эвакуированным по всему миру, изучать арифметику и математику на родном языке.",
          replies6:
            "Переводчица Ирина систематически переводила около 600 видеоматериалов по арифметике и математике для школьников от начальной до старшей школы. Эта инициатива освещалась в СМИ и получила несколько наград. Мы чрезвычайно благодарны за её целеустремлённый вклад.",
          replies7: "Узнал об Ирине от украинских беженцев.",
          replies8:
            "Во время разговора с украинской организацией, получившей Нобелевскую премию мира, мы попросили перевод на украинский и японский языки.",
          replies9:
            "Я мог спокойно общаться с украинцами. Ирина хорошо знает японский язык, поэтому её японскую речь легко понять. Я всегда консультируюсь с госпожой Дергачёвой, когда общаюсь с украинцами.",
          replies10:
            "Это был запрос на устный, транскрипционный и видеоперевод с украинского и русского языков на японский.",
          replies11:
            "Ирина не раз приходила к нам в офис и всегда работала очень аккуратно. Когда я увидел перевод длинной записи с украинского на японский язык, я подумал, что её уровень владения японским языком очень высок. Она также предоставила подробные заметки и пояснения к справочной информации. Скорость работы также была высокой. Её коммуникативные навыки были отличными: она правильно понимала наши просьбы и качественно выполняла работу.",
          ...
          translationText8:
            "Свяжитесь со мной сегодня для бесплатной 30-минутной консультации!",
                   ...
                   // Form of payment
          pay: "Оплатить",
          enter: "Введите сумму оплаты",
          example: "Например",
          cancel: "Отмена",
          amount: "Введите сумму больше 0",
          loading: "Загрузка...",
          failed: "Ошибка при создании сессии оплаты",
